...
template <RcBit rc> void ppc_opc_mffsx(uint32 opc);
...
template <RcBit rc> void ppc_opc_mtfsb0x(uint32 opc);
template <RcBit rc> void ppc_opc_mtfsb1x(uint32 opc);
template <RcBit rc> void ppc_opc_mtfsfx(uint32 opc);
template <RcBit rc> void ppc_opc_mtfsfix(uint32 opc);
